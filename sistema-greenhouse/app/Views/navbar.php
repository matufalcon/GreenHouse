        ...
        <div class="container">
            ...
            <ul class="navbar-nav ms-auto">
                <li class="nav-item mx-2">
                    <a class="btn btn-primary" style="background-color: #27D99D;" href="inicio">Inicio</a>
                </li>
                <li class="nav-item mx-2">
                    <a class="btn btn-primary" style="background-color: #27D99D;" href="#">Explorar cabañas</a>
                </li>
                <li class="nav-item mx-2">
                    <a class="btn btn-primary" style="background-color: #27D99D;" href="reservar">Reservas</a>
                </li>
                <li class="nav-item mx-2">
