    ...
    <div class="row">
        <div class="col-12 p-0">
            ...
            <div class="position-absolute top-50 start-0 translate-middle-y px-3">
                <p class="lead text-start font-weight-bold" style="font-size: 2.6em; color: white">Tomate un descanso y
                    disfruta de una estadia en una cabaña.</p>
...
<div class="container-fluid" style="background-color: #0a3440; padding: 50px;" id="conocenos">
    <div class="row">
        ...
        <div class="col-md-6 text-light">
            <p>
                Green House es una empresa dedicada a la preservación del medio ambiente y la promoción de la vida
                sostenible. Fundada en 2005, nos hemos comprometido a crear un futuro más verde y saludable para las
                generaciones venideras.
            </p>
            <p>
                Nuestros productos orgánicos y métodos de cultivo ecológicos han sido reconocidos internacionalmente por
                su calidad y sostenibilidad. Trabajamos en estrecha colaboración con las comunidades locales para
                promover la agricultura sostenible y reducir nuestra huella de carbono.
            </p>
        </div>
    </div>
</div>
